...
|**GEMM API 参考(3.x)**|`media/docs/cpp/gemm_api_3x.md`|Ch11 — Builder 的 4 步"装配内核"配方|
...
|**高效 GEMM 设计与伪码**|`media/docs/cpp/efficient_gemm.md`|Ch8 — 经典 5 层 nested-loop 伪码|
...
|**CUTLASS 代码风格 / Params / SharedStorage 约定**|`media/docs/cpp/programming_guidelines.md`|Ch2 + Ch5 — Params/SharedStorage 惯例|
|**CUTLASS ↔ 数据类型支持表**|`media/docs/cpp/functionality.md`|(查询用)|
|**数值类型 catalog**|`media/docs/cpp/fundamental_types.md`|Ch10 — sm_100 mx_* 类型说明|
|**性能测量方法学**|`media/docs/cpp/gemm_performance_measurement_methodology_guidelines.md`|Ch13 — 测量 cuBLAS 对比时的科学方法|
|**profiler CLI**|`media/docs/cpp/profiler.md`|Ch13.6|
|**heuristics / autotune**|`media/docs/cpp/heuristics.md`|Ch13.6|
...
|**依赖 kernel launch(PDL)**|`media/docs/cpp/dependent_kernel_launch.md`|Ch13.4 / 附录 D|
...
|**CuTe + TMA**|`media/docs/cpp/cute/0z_tma_tensors.md`|Ch5 — 读懂 TMA + CuTe 联合用法|
